...
final historialOrdenTrabajoProvider = FutureProvider.family<List<HistorialCambioEstado>, String>((
  ref,
  ordenId,
) async {
...
final estadisticasOrdenTrabajoProvider = FutureProvider.family<EstadisticasTiempos, String>((
  ref,
  ordenId,
) async {
